package template.cheng.hollis.template.Panorama;
...
//    private MDPosition logoPositionB = MDPosition.newInstance().setY(-12.0f).setY(-1.0f).setPitch(-7.187925f).setYaw(-45.844486f).setRoll(1.4273872f);
    private MDPosition logoPositionB = MDPosition.newInstance().setZ(-12.0f).setY(-1.0f);
        ...
        SpinnerHelper.with(this)
                ...
                .setClickHandler(new SpinnerHelper.ClickHandler() {
                    ...
                    public void onSpinnerClicked(int index, int key, String value) {
                        ...
                        Utility.PrintLog(getClass().getName(), "motion position key=" + key);
                    }
                })
...
//                                    Utility.PrintLog(getClass().getName(), "add_plugin clicked");
//                                }
//                            }
//                        })
//                        .title("star" + index)
...
//                Utility.PrintLog(getClass().getName(), "add plugin position:=" + position);
//            }
//        });
...
//                MDHotspotBuilder builder = MDHotspotBuilder.create(mImageLoadProvider)
//                        .size(4f, 4f)
//                        .provider(activity, R.drawable.icon_active_bookmark)
//                        .title("logo")
...
//                                Utility.PrintLog(getClass().getName(), "add_plugin_logo clicked");
//                            }
//                        });
...
//                Utility.PrintLog(getClass().getName(), "add plugin logo position=" + logoPosition);
//            }
//        });
        ...
        findViewById(R.id.button_add_hotspot_front).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MDHotspotBuilder builder = MDHotspotBuilder.create(mImageLoadProvider)
                        ...
                        .title("front logo")
                        .tag("tag-front")
                        .position(mdp = MDPosition.newInstance().setZ(-12.0f).setY(-1.0f));
                MDAbsHotspot hotspot = new MDSimpleHotspot(builder);
                hotspot.rotateToCamera();
                plugins.add(hotspot);
                getVRLibrary().addPlugin(hotspot);
                Utility.PrintLog(getClass().getName(), "MDPosition.newInstance().setZ(-12.0f).setY(-1.0f).toString()=" + MDPosition.newInstance().setZ(-12.0f).setY(-1.0f).toString());
                Utility.PrintLog(getClass().getName(), "directorBriefText=" + directorBriefText.getText());
                Utility.PrintLog(getClass().getName(), "mdp=" + mdp.toString());
            }
        });
...
//                .init(R.id.spinner_pitch_filter);
    ...
    private void init() {
        try {
            mVRLibrary.switchInteractiveMode(MD360PlayerActivity.this, 3);
            ...
            if (IsChanged) {
                builder = MDHotspotBuilder.create(mImageLoadProvider)
                        ...
                        .provider(activity, R.drawable.icon_active_bookmark)
                        .title("logo")
                        .position(logoPositionB)
                        .listenClick(new MDVRLibrary.ITouchPickListener() {
                            @Override
                            public void onHotspotHit(IMDHotspot hitHotspot, MDRay ray) {
                                Toast.makeText(MD360PlayerActivity.this, "click logo2", Toast.LENGTH_SHORT).show();
                                busy();
                                String url;
                                url = "https://upload.wikimedia.org/wikipedia/commons/8/86/360-degree_Panorama_of_the_Southern_Sky_edit.jpg";
                                IsChanged = false;
                                BitmapPlayerActivity.nextUri = Uri.parse(url);
                ...
                builder = MDHotspotBuilder.create(mImageLoadProvider)
                        ...
                        .listenClick(new MDVRLibrary.ITouchPickListener() {
                            @Override
                            public void onHotspotHit(IMDHotspot hitHotspot, MDRay ray) {
                                Toast.makeText(MD360PlayerActivity.this, "click logo1", Toast.LENGTH_SHORT).show();
                                busy();
                                String url;
                                url = "http://4.bp.blogspot.com/_BZhaBQfPrpw/TNhsAZC0oII/AAAAAAAAATg/CwTEH968hPs/s1600/_D0M7193Dom+Bower+Photography+Panorama.jpg";
                                IsChanged = true;
                                BitmapPlayerActivity.nextUri = Uri.parse(url);
                                getVRLibrary().notifyPlayerChanged();
                                plugins.clear();
            ...
            Utility.PrintLog(getClass().getName(), "init error=" + e.toString());
        }
    }
