...
/**
 * Created by hollischeng on 18/8/2016.
 */
public class DefaultScrollTopSpinner extends Spinner {

    private boolean mToggleFlag = true;

    public DefaultScrollTopSpinner(Context context, AttributeSet attrs,
    ...
    public DefaultScrollTopSpinner(Context context, int mode) {
        super(context, mode);
    }

    public DefaultScrollTopSpinner(Context context) {
        super(context);
    }
